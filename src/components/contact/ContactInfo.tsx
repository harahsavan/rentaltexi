...
const ContactInfo = () => {
    ...
    const [userCarData, setUserCarData] = useState<Car>();
    ...
    useEffect(() => {
        ...
        if (storedData) {
            ...
            if (emailId?.email) {
                ...
                const updatedSelectedCars = [...existingSelectedCars, updatedCarInfo];
    ...
    return (
        <>
            <div
                ...
                {userCarData && <PaymentComponent userCarData={userCarData} />}
