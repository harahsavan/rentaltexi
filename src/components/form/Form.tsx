...
const Form = () => {
    ...
    const handleSubmitData = async (e: React.FormEvent) => {
        ...
        if (selectedOption === "local" && !formData.city) {
            console.error("Please enter the city for a local trip.");
            return;
        } else if ((selectedOption === "oneWay" || selectedOption === "roundTrip") && (!cityFrom || !cityTo)) {
            console.error("Please select both cities.");
            return;
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                console.error(errorData.error || "Something went wrong with the distance calculation.");
                return;
            }
