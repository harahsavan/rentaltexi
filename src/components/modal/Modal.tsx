...
interface City {
    city: string; // Assuming each city in the list has a 'city' property.
  }
  ...
  interface ModalProps {
    ...
    handleInputChangeModal: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
    setIsModalOpen: (isOpen: boolean) => void;
    cities: City[];
    city1: string;
    city2: string;
    setCity1: (city: string) => void;
    setCity2: (city: string) => void;
  }
  

const Modal = ({ handleSave, formValues, handleInputChangeModal, setIsModalOpen, cities, city1, city2, setCity1, setCity2, }: ModalProps) => {
